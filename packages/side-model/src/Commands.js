...
const ArgTypes_1 = __importDefault(require("./ArgTypes"));
exports.default = {
    acceptAlert: {
        name: 'accept alert',
    ...
    answerPrompt: {
        ...
        target: ArgTypes_1.default.answer,
    },
    assert: {
        name: 'assert',
    ...
    assertNotSelectedValue: {
        ...
        target: ArgTypes_1.default.selectLocator,
        value: ArgTypes_1.default.pattern,
    },
    assertNotText: {
    ...
    assertTitle: {
      ...
      The test will stop if the assert fails.`,
        target: ArgTypes_1.default.pattern,
    },
    assertValue: {
        name: 'assert value',
    ...
    clickAt: {
        ...
        target: ArgTypes_1.default.locator,
        value: ArgTypes_1.default.coord,
    },
    close: {
        name: 'close',
    ...
    elseIf: {
        ...
        target: ArgTypes_1.default.conditionalExpression,
    },
    end: {
        name: 'end',
    ...
    executeScript: {
        ...
        target: ArgTypes_1.default.script,
    ...
    forEach: {
        ...
        target: ArgTypes_1.default.arrayVariableName,
        value: ArgTypes_1.default.iteratorVariableName,
    },
    if: {
        name: 'if',
    ...
    open: {
        ...
        target: ArgTypes_1.default.url,
    },
    pause: {
        name: 'pause',
        description: 'Wait for the specified amount of time.',
        target: ArgTypes_1.default.waitTime,
    },
    removeSelection: {
        ...
        target: ArgTypes_1.default.locator,
        value: ArgTypes_1.default.optionLocator,
    },
    repeatIf: {
        name: 'repeat if',
        ...
        target: ArgTypes_1.default.conditionalExpression,
        value: ArgTypes_1.default.loopLimit,
    },
    run: {
        name: 'run',
        description: 'Runs a test case from the current project.',
        target: ArgTypes_1.default.testCase,
    },
    runScript: {
        name: 'run script',
    ...
    selectWindow: {
        ...
        target: ArgTypes_1.default.handle,
    },
    sendKeys: {
        name: 'send keys',
        ...
        target: ArgTypes_1.default.locator,
        value: ArgTypes_1.default.keySequence,
    },
    setSpeed: {
        name: 'set speed',
    ...
    setWindowSize: {
        ...
        target: ArgTypes_1.default.resolution,
    },
    store: {
        name: 'store',
        description: 'Save a target string as a variable for easy re-use.',
        target: ArgTypes_1.default.text,
        value: ArgTypes_1.default.variableName,
    },
    storeAttribute: {
        ...
        target: ArgTypes_1.default.attributeLocator,
        value: ArgTypes_1.default.variableName,
    },
    storeElementCount: {
    ...
    storeJson: {
        ...
        target: ArgTypes_1.default.json,
        value: ArgTypes_1.default.variableName,
    },
    storeText: {
        name: 'store text',
    ...
    times: {
        ...
        target: ArgTypes_1.default.times,
        value: ArgTypes_1.default.loopLimit,
    },
    type: {
        name: 'type',
    ...
    verifyNotSelectedValue: {
        ...
        target: ArgTypes_1.default.selectLocator,
        value: ArgTypes_1.default.option,
    },
    verifyNotText: {
    ...
    waitForElementEditable: {
        ...
        target: ArgTypes_1.default.locator,
        value: ArgTypes_1.default.waitTime,
    },
